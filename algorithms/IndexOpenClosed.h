 ...
 */
template<typename state, typename CmpKey, class dataStructure>
uint64_t IndexOpenClosed<state, CmpKey, dataStructure>::AddOpenNode(const state &val, uint64_t hash, double g, double h,double p, uint64_t parent)
{
 ...
 */
template<typename state, typename CmpKey, class dataStructure>
uint64_t IndexOpenClosed<state, CmpKey, dataStructure>::AddClosedNode(state &val, uint64_t hash, double g, double h,double p, uint64_t parent)
{
	// shouldn't be in open/closed already
